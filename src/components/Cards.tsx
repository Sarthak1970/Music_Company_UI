...
function Testimonials() {
  return (
    <div className="relative h-[40rem] w-full overflow-hidden flex flex-col items-center justify-center bg-white dark:bg-black">

      {/* Grid Background Layer */}
      <div className="absolute inset-0 -z-10 [background-size:40px_40px] 
        [background-image:linear-gradient(to_right,#e4e4e7_1px,transparent_1px),linear-gradient(to_bottom,#e4e4e7_1px,transparent_1px)] 
        dark:[background-image:linear-gradient(to_right,#262626_1px,transparent_1px),linear-gradient(to_bottom,#262626_1px,transparent_1px)]">
      </div>

      {/* Optional radial fade effect */}
